...
class ControllerExtensionPaymentWebPos extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/payment/webpos', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		}
		...
		$data['tab_add_url'] = $this->url->link('extension/webposbuilder', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		'href' => $this->url->link('extension/payment/webpos', 'user_token=' . $this->session->data['user_token'], 'SSL')
		);
		...
		if (isset($this->request->post['payment_webpos_geo_zone_id'])) {
			$data['payment_webpos_geo_zone_id'] = $this->request->post['payment_webpos_geo_zone_id'];
		} else {
			$data['payment_webpos_geo_zone_id'] = $this->config->get('payment_webpos_geo_zone_id');
		}
