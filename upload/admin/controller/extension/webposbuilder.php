...
class ControllerExtensionWebposBuilder extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('extension/webposbuilder', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/webposbuilder', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);
		
		$data['add'] = $this->url->link('extension/webposbuilder/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('extension/webposbuilder/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$data['banks'][] = array(
				...
				'edit'      => $this->url->link('extension/webposbuilder/edit', 'user_token=' . $this->session->data['user_token'] . '&bank_id=' . $result['bank_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('extension/webposbuilder', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('extension/webposbuilder', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('extension/webposbuilder', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/webposbuilder_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['bank_id'])) { 
			$data['action'] = $this->url->link('extension/webposbuilder/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('extension/webposbuilder/edit', 'user_token=' . $this->session->data['user_token'] . '&bank_id=' . $this->request->get['bank_id'] . $url, 'SSL');
		}
		
		$data['cancel'] = $this->url->link('extension/webposbuilder', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/webposbuilder_form', $data));
	}
